...
В приложении используются такие библиотеки: React(основа приложения), React Transition Group(простые анимации), React Helmet(для управления заголовком страницы), formik + yup(для валидации формы).
